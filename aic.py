...
yweather = YahooWeather(29000476, UNIT_C)
...
def command(inpt):
    ...
    #-----------------------------------------------------------------COMMAND---------------------------------------------------------------------------------------------
    #-----------------------------------------------------------------COMMAND---------------------------------------------------------------------------------------------
    if "it is another command" in inpt:
    ...
    #-----------------------------------------------------------------WEATHER---------------------------------------------------------------------------------------------
        ...
        huint = int(humi)
        if huint > 66:
            speak("The percentage of humidity in the air is more than the marks you got in hindi and math!! Loser can't get good marks in math and his own mother tongue! Shame Shame Shame. Your marks disgust me! It is "+humidity)
        else:
            speak(humidity)
        time.sleep(30)
    ...
    #--------------------------------------------------------------------NEWS----------------------------------------------------------------------------------------------
        ...
        j = '\n'.join(str(e) for e in k)
        speaklong (k,j)
    elif "when I say" in inpt or "when i say" in inpt:
    ...
    #-----------------------------------------------------------------SMARTNESS--------------------------------------------------------------------------------------------
        ...
        while(xqwert>xyz):
            if list23[xyz] in inpt:
                x = list23[xyz+1]
                speak("According to your previous comments: "+x)
                break
            else:
                    xyz+=2
        with open('test1.txt') as f:
        ...
        while(xqwert>xyz):
            if list23[xyz] in inpt:
                ...
                speak("This is what I found in a list"+y)
            else:
                xyz+=2
        with open('command.txt') as f:
            content = f.readlines()
        ...
        k = x[a+1:b-1]
        j = ' '.join(str(e) for e in k)
        speaklong("Crigy web results that I found online: "+k,"Crigy web results that I found online: "+j)
