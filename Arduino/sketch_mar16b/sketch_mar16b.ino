...
void loop(void) {
  ...
  drawBitmap(0, 10, title, 200, 30,WHITE);
  drawBitmap(5, 70, car, 195, 146,GREEN);
  delay(2000);
  drawBitmap(0, 10, title, 200, 30,BLUE);
  drawBitmap(5, 70, car, 195, 146,RED);
  delay(2000);
  drawBitmap(0, 10, title, 200, 30,RED);
  drawBitmap(5, 70, car, 195, 146,BLUE);
  delay(2000); 
  tft.fillScreen(WHITE); //Make screen white
  drawBitmap(0, 10, title, 200, 30,BLACK);
  drawBitmap(5, 70, car, 195, 146,BLACK);
  delay(2000);
}
